...
interface ModelInterface {
	...
	abstract int update(Map<String,Object> updateParameters, Map<String,Object> whereParameters) throws Exception;
        ...
        abstract int updateTransaction(Map<String,Object> updateParameters, Map<String,Object> updateParameters1, Map<String,Object> whereParameters) throws Exception;
		...
		switch(viewData.operationName) {
			...
			case "update":
			{
				...
				return new ModelData(viewData.functionName, recordCount);
                        ...
                        {
                                Map<String, Object> updateParameters = (Map<String, Object>)(viewData.viewParameters.get("updateParameters"));
                                Map<String, Object> updateParameters1 = (Map<String, Object>)(viewData.viewParameters.get("updateParameters1"));
				Map<String, Object> whereParameters = (Map<String, Object>)(viewData.viewParameters.get("whereParameters"));
				
				int recordCount = updateTransaction(updateParameters, updateParameters1, whereParameters);
				
				return new ModelData("update", recordCount);
                        }
			case "delete":
			{
				Map<String, Object> whereParameters = (Map<String, Object>)(viewData.viewParameters.get("whereParameters"));
