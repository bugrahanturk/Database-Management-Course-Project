 ...
 */
public class AyniKisiBasvurulariModel implements ModelInterface {
    ...
    public ResultSet select(Map<String, Object> whereParameters) throws Exception {
        ...
        sql.append(" SELECT ");
        sql.append("	BasvuruNumarasi, İsim, Soyisim, BasvuruMetni, BasvuruCevapSonTarihi, DurumAciklamasi ");
